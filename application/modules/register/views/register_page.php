							...
							<div class="row justify-content-center">
								<div class="col-md-10 col-lg-8">
										...
										<div class="card p-4">
											<div class="card-body">
												...
												<div class="row">
													...
													<div class="row">
														<div class="col-12">
															<button type="button" class="btn  btn-lg btn-primary btn-block px-4"><i class="fe fe-arrow-right"></i> Create account</button>
														</div>
									...
									<div class="text-center pt-4">
										<div class="font-weight-normal fs-16">Already have an account? <a class="btn-link font-weight-normal" href="<?= site_url('login'); ?>">Login Here</a></div>
									</div>
								</div>
							</div>
						</div>
