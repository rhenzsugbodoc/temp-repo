                                                ...
                                                <div class="card-header">
                                                    ...
                                                    <div class="card-options">
                                                        ...
                                                        <div class="btn-group ml-5 mb-0">
                                                            <button type="button" class="btn btn-white dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="fe fe-plus"></i>Sort By</button>
                                                ...
                                                <div class="card-body">
                                                    <div class="table-responsive">
                                                        <table id="example1" class="table table-striped table-bordered text-nowrap" style={{width: "100%"}}>
                                                            <thead>
                                                                <tr class="bold">
                                                                    <th class="border-bottom-0">Caregiver ID </th>
                                                                    <th class="border-bottom-0">Name</th>
                                                                    <th class="border-bottom-0">Role</th>
                                                                    <th class="border-bottom-0">Care Type</th>
                                                                    <th class="border-bottom-0">Care Schedule</th>
