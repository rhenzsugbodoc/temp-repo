...
import Head from '../../common/views/head.jsx';
import Footer from '../../common/views/footer.jsx'; 
import Menu from '../../common/views/menu.jsx';
                            ...
                            <div className="side-app">
                                    ...
                                    <div className="app-header header top-header">
                                        <div className="container-fluid">
                                            <div className="d-flex">
                                                <a className="header-brand" href="<?php echo base_url('pages/index'); ?>">
                                                    <img src="<?php echo base_url('public/assets/images/brand/logo.png'); ?>" className="header-brand-img desktop-lgo" alt="Rygel Dash logo"/>
                                                    <img src="<?php echo base_url('public/assets/images/brand/logo1.png'); ?>" className="header-brand-img dark-logo" alt="Rygel Dash logo"/>
                                                    <img src="<?php echo base_url('public/assets/images/brand/favicon.png'); ?>" className="header-brand-img mobile-logo" alt="Rygel Dash logo"/>
                                                    <img src="<?php echo base_url('public/assets/images/brand/favicon1.png'); ?>" className="header-brand-img darkmobile-logo" alt="Rygel Dash logo"/>
                                                </a>
                                                <div className="dropdown side-nav">
                                                    <div className="app-sidebar__toggle" data-toggle="sidebar">
                                                        ...
                                                        <a className="close-toggle" href="#">
                                                            <svg className="header-icon mt-1" xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/>
                                                            </svg>
                                                ...
                                                {/* <!-- <div className="dropdown  header-option">
                                                    <a className="nav-link icon p-0" data-toggle="dropdown">
                                                        ...
                                                        <span className="nav-span">Projects <i className="fa fa-angle-down ml-1 fs-18"></i></span>
                                                    </a>
                                                    <div className="dropdown-menu dropdown-menu-left dropdown-menu-arrow animated">
                                                        ...
                                                        <div className="text-left pr-5 pl-5 p-2 border-top">
                                                            <a href="#" className="">View Projects</a>
                                                        </div>
                                                    </div>
                                                </div> --> */}
                                                <div className="d-flex order-lg-2 ml-auto">
                                                    <a href="#" data-toggle="search" className="nav-link nav-link-lg d-md-none navsearch">
                                                    ...
                                                    {/* <!-- SEARCH --> */}
                                                    <div className="dropdown   header-fullscreen pl-5" >
                                                        <a  className="nav-link icon full-screen-link p-0"  id="fullscreen-button">
                                                    ...
                                                    <div className="dropdown header-notify pl-4">
                                                        <a className="nav-link icon p-0" data-toggle="dropdown">
                                                        ...
                                                        <div className="dropdown-menu dropdown-menu-right dropdown-menu-arrow  animated">
                                                            <a href="#" className="dropdown-item d-flex pb-3">
                                                                <svg className="header-icon mr-4" x="1008" y="1248" viewBox="0 0 24 24"  height="100%" width="100%" preserveAspectRatio="xMidYMid meet" focusable="false">
                                                            ...
                                                            <a href="#" className="dropdown-item d-flex pb-3">
                                                                ...
                                                                <div>
                                                                    <div className="font-weight-bold">Your Admin lanuched</div>
                                                    ...
                                                    <div className="dropdown profile-dropdown">
                                                        <a href="#" className="nav-link pr-0 leading-none" data-toggle="dropdown">
                                                            <span>
                                                                <img src="<?php echo base_url('public/assets/images/users/16.jpg'); ?>" alt="img" className="avatar avatar-md brround"/>
                                                            </span>
                                                        </a>
                                                        <div className="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
                                                            <div className="text-center">
                                                                <a href="#" className="dropdown-item text-center user pb-0 font-weight-bold">John Thomson</a>
                                                                <span className="text-center user-semi-title">Patient</span>
                                                                <div className="dropdown-divider"></div>
                                                            </div>
                                                            <a className="dropdown-item d-flex" href="#">
                                                                <svg className="header-icon mr-3" x="1008" y="1248" viewBox="0 0 24 24"  height="100%" width="100%" preserveAspectRatio="xMidYMid meet" focusable="false">
                                        ...
                                        <div className="col-xl-9 col-md-12 col-lg-12">
                                            <div className="row">
                                                ...
                                                <div className="col-xl-12 col-md-12 col-lg-12">
                                                    <div className="card">
                                                        <div className="card-header">
                                                            <div className="card-title">Current care Plan</div>
                                                        </div>
                                                        <div className="card-body">
                                                            <p>No Current Care Plan</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <div className="row row-deck">
                                        <div className="col-xl-12 col-lg-12 col-md-12">
                                            <div className="card">
                                                <div className="card-header">
                                                    <h3 className="card-title">Current Care Providers</h3>
                                                    <div className="card-options">
                                                        <div className="btn-group ml-5 mb-0">
                                                            <button
                                                                ...
                                                                aria-expanded="false"
                                                            >
                                                                <i className="fe fe-plus"></i>Expand
                                                            </button>
                                                            <div className="dropdown-menu">
                                                                <a className="dropdown-item" href="#">
                                                                    <i className="fa fa-plus mr-2"></i>Add new Order
                                                                </a>
                                                                <a className="dropdown-item" href="#">
                                                                    <i className="fa fa-eye mr-2"></i>View all new tab
                                                                </a>
                                                                <a className="dropdown-item" href="#">
                                                                    <i className="fa fa-edit mr-2"></i>Edit Page
                                                                </a>
                                                                <div className="dropdown-divider"></div>
                                                                <a className="dropdown-item" href="#">
                                                ...
                                                <div className="card-body">
                                                    <div className="table-responsive">
                                                        ...
                                                        >
                                                            <thead>
                                                                <tr className="bold">
                                                                    <th className="border-bottom-0">Caregiver ID </th>
                                                                    <th className="border-bottom-0">Name</th>
                                                                    <th className="border-bottom-0">Role</th>
                                                                    <th className="border-bottom-0">Care Type</th>
                                                                    <th className="border-bottom-0">Care Schedule</th>
                                                                    <th className="text-center border-bottom-0">Status</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody></tbody>
                                                        </table>
