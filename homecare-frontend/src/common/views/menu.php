		...
		<div class="page">
			<div class="page-main">
				...
				<div class="app-sidebar app-sidebar2">
					<div class="app-sidebar__logo d-flex flex-row justify-content-center align-items-center">
						<a class="d-flex flex-row justify-content-center align-items-center gap-4" href="<?php echo base_url('Landing'); ?>">
							<img src="<?php echo base_url('public/assets/images/png/HomeCareLogo.png'); ?>"  alt="Rygel Dash logo">
							<h3>HomeCare</h3>
						</a>
					...
					<!-- <div class="app-sidebar__user">
						<div class="dropdown user-pro-body text-center">
							...
							<div class="user-info">
								...
								<span class="text-muted app-sidebar__user-name text-sm">Patient</span>
							</div>
						</div>
					</div> -->
					<ul class="side-menu">
						...
						<li class="slide">
							...
							<img src="<?php echo base_url('public/assets/images/png/ScheduleSymbol.png'); ?>" class="side-menu__icon">							
							<span class="side-menu__label">Today's Schedule</span><i class="angle fa fa-angle-right"></i></a>
							<ul class="slide-menu">
								<li class="sub-slide">
						...
						<li class="slide">
							...
							<span class="side-menu__label">Calendar</span><i class="angle fa fa-angle-right"></i></a>
							<ul class="slide-menu">
								<li class="sub-slide">
						...
						<li class="slide">
							...
							<span class="side-menu__label">Care Providers</span><i class="angle fa fa-angle-right"></i></a>
							<ul class="slide-menu">
						...
						<li class="slide">
							...
							<span class="side-menu__label">Clinical Notes</span><i class="angle fa fa-angle-right"></i></a>
							<ul class="slide-menu">
						...
						<li class="slide">
							...
							<span class="side-menu__label">Files</span><i class="angle fa fa-angle-right"></i></a>
							<ul class="slide-menu">
						...
						<li class="slide">
							...
							<span class="side-menu__label">Prescriptions</span><i class="angle fa fa-angle-right"></i></a>
							<ul class="slide-menu">
						...
						<li class="slide">
							...
							<span class="side-menu__label">User Account</span><i class="angle fa fa-angle-right"></i></a>
							<ul class="slide-menu">
								<li class="sub-slide">
						...
						<div class="dropdown text-center">
							<div class="help d-flex">
								<a href="#" class="nav-link p-0 help-dropdown" data-toggle="dropdown">
									<span class="font-weight-bold">About Us</span> <i class="fa fa-angle-down ml-2"></i>
								</a>
									...
									<div class="dropdown side-nav">
										<div class="app-sidebar__toggle" data-toggle="sidebar">
											...
											<a class="close-toggle" href="#">
												<svg class="header-icon mt-1" xmlns="http://www.w3.org/2000/svg" height="24" width="24" viewBox="0 0 24 24" fill="currentColor"><path d="M8 5v14l11-7z"/>
                                                </svg>
										...
										<div class="dropdown profile-dropdown">
											...
											<div class="dropdown-menu dropdown-menu-right dropdown-menu-arrow animated">
												<div class="text-center">
													...
													<span class="text-center user-semi-title">Patient</span>
