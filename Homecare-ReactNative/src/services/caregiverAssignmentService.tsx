...
class CaregiverAssignmentService {
   ...
   * GET /api/caregiver-assignments/care-plan?care_plan_id=:id
   */
  async getAssignmentsByCarePlan(carePlanId: number): Promise<CaregiverAssignment[]> {
    try {
      const response = await api.get('/api/caregiver-assignments/care-plan', {
   ...
   * GET /api/caregiver-assignments/patient?patient_id=:id
   */
  async getAssignmentsByPatient(patientId: number): Promise<CaregiverAssignment[]> {
    try {
      const response = await api.get('/api/caregiver-assignments/patient', {
