...
import { Animated, View, ScrollView, Image, TextInput, ImageBackground, Pressable, StyleSheet, Text, Dimensions,TouchableWithoutFeedback, ViewStyle, TouchableOpacity  } from 'react-native';
...
export default function PatientDashboard() {
  ...
  const prescriptionList: Prescription[] = [
    { id: 1, name: 'Paracetamol', price: 50, dosage: '500 mg', image: require('../../../assets/images/Paracetamol.png')},
    { id: 2, name: 'Ibuprofen', price: 75, dosage: '200 mg', image: require('../../../assets/images/Ibuprofen.png')},
    { id: 3, name: 'Amoxicillin', price: 120, dosage: '500 mg', image: require('../../../assets/images/Amoxicillin.png')},
    { id: 4, name: 'Cetirizine', price: 60, dosage: '10 mg', image: require('../../../assets/images/Cetirizine.png')},
    { id: 5, name: 'Aspirin', price: 40, dosage: '325 mg', image: require('../../../assets/images/Aspirin.png') },
    { id: 6, name: 'Azithromycin', price: 200, dosage: '250 mg', image: require('../../../assets/images/Azothromycin.png')},
    { id: 7, name:'Diclofenac', price: 90, dosage: '50 mg', image: require('../../../assets/images/Diclofenac.png')},
    { id: 8, name: 'Omeprazole', price: 130, dosage: '20 mg', image: require('../../../assets/images/Omeprazole.png')},
    { id: 9, name: 'Loratadine', price: 70, dosage: '10 mg', image: require('../../../assets/images/Loratadine.png')},
    { id: 10,name: 'Solmux', price: 150, dosage: '500 mg', image: require('../../../assets/images/Solmux.png')},
  ];
  ...
  const pharmacyList = [
    { id: 1, name: "CLARK'S PHARMACY - TALAMBAN", rating: 4.5, distance: 2.3, image: require('../../../assets/images/Clarks.png')},
    { id: 2, name: 'MERCURY DRUGSTORE - MANDAUE', rating: 4.2, distance: 5.7, image: require('../../../assets/images/Mercury.png')},
    { id: 3, name: 'ROSE PHARMACY - TALISAY', rating: 3.8, distance: 7.1, image: require('../../../assets/images/Rose.png')},
    { id: 4, name: 'ROSE PHARMACY - MANDAUE', rating: 4.0, distance: 1.5, image: require('../../../assets/images/Rose2.png')},
  ];
        ...
        <View style={{flexDirection: 'row', gap: 10, marginTop: 15, paddingHorizontal: 35}}>
            ...
            <View style={styles.pickerContainer}>
              <Picker
                ...
                style={{color: '#333'}}
              >
                <Picker.Item label="   Filter" value="default" />
            ...
            <Animated.View style={[styles.popup, { transform: [{ translateY: slideAnim }] }]}>
              <View style={styles.popupContent}>
                ...
                <View style={{flexDirection: 'row', gap:10, margin: 10, paddingBottom: 15 }}>
                    <View style={{ flex: 3 }}>
                      <Image source={selectedPrescription?.image} resizeMode="cover" 
